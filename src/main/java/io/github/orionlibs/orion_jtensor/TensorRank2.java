...
public class TensorRank2<T> extends ATensor
{
    public TensorRank2(Class<?> dataType, int... dimensions)
    {
        super(dataType, dimensions);
        Assert.isTrue(dimensions.length == 2, "A rank-2 tensor must have 2 dimensions");
