...
public class TensorRank3<T> extends ATensor
{
    public TensorRank3(Class<?> dataType, int... dimensions)
    {
        super(dataType, dimensions);
        Assert.isTrue(dimensions.length == 3, "A rank-3 tensor must have 3 dimensions");
